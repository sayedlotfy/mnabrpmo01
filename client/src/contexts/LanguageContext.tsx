...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    durationLog: "Duration Log",
    pauseReason: "Reason for Stopping",
    resumeReason: "Reason for Resuming",
    pauseReasonPlaceholder: "Describe the reason for stopping the project...",
    resumeReasonPlaceholder: "Describe the reason for resuming the project...",
    reasonRequired: "Reason is required (min 5 characters)",
    confirmPause: "Confirm Stop",
    confirmResume: "Confirm Resume",
    totalContractDays: "Contract Days (Working)",
    consumedDays: "Consumed Days",
    remainingDays: "Remaining Days",
    pausedDays: "Paused Days",
    eventPause: "Project Stopped",
    eventResume: "Project Resumed",
    noEvents: "No events recorded yet",
    recordedBy: "Recorded by",
    eventDate: "Date",
    saudiCalendar: "Saudi Working Calendar (Sun-Thu)",
    holidaysExcluded: "Official Saudi holidays excluded",
    workingDaysNote: "Working days: Sunday to Thursday, excluding Saudi public holidays",
    ...
    pauseConfirmTitle: "Stop Project",
    resumeConfirmTitle: "Resume Project",
    pauseConfirmDesc: "This will stop the project clock. Please provide a reason.",
    resumeConfirmDesc: "This will resume the project clock. Please provide a reason.",
    timelineTab: "Timeline & Duration",
    ...
    internalTransfersDesc: "Payments to internal departments or individuals within the company",
    ...
    statusPaid: "Paid",
    noTransfers: "No internal transfers recorded yet.",
    totalTransfers: "Total Internal Transfers",
    transfersPending: "Pending Transfers",
    transfersPaid: "Paid Transfers",
  ...
  ar: {
    ...
    durationLog: "سجل المدة",
    pauseReason: "سبب الإيقاف",
    resumeReason: "سبب الاستئناف",
    pauseReasonPlaceholder: "صف سبب إيقاف المشروع...",
    resumeReasonPlaceholder: "صف سبب استئناف المشروع...",
    reasonRequired: "السبب مطلوب (5 أحرف على الأقل)",
    confirmPause: "تأكيد الإيقاف",
    confirmResume: "تأكيد الاستئناف",
    totalContractDays: "أيام العقد (عمل فعلي)",
    consumedDays: "الأيام المستهلكة",
    remainingDays: "الأيام المتبقية",
    pausedDays: "أيام التوقف",
    eventPause: "توقف المشروع",
    eventResume: "استئناف المشروع",
    noEvents: "لا توجد أحداث مسجلة بعد",
    recordedBy: "سجله",
    eventDate: "التاريخ",
    saudiCalendar: "تقويم العمل السعودي (أحد-خميس)",
    holidaysExcluded: "مستثنى الإجازات الرسمية السعودية",
    workingDaysNote: "أيام العمل: الأحد إلى الخميس، مستثنى الإجازات الرسمية والأعياد الوطنية السعودية",
    durationSummary: "ملخص المدة",
    netWorkingDays: "صافي أيام العمل",
    calendarDays: "أيام تقويمية",
    stoppageCount: "عدد مرات التوقف",
    currentlyPaused: "متوقف حالياً",
    currentlyActive: "نشط حالياً",
    pauseConfirmTitle: "إيقاف المشروع",
    resumeConfirmTitle: "استئناف المشروع",
    pauseConfirmDesc: "سيتوقف عداد أيام المشروع. يرجى تدوين السبب.",
    resumeConfirmDesc: "سيستأنف عداد أيام المشروع. يرجى تدوين السبب.",
    timelineTab: "الجدول الزمني والمدة",
    ...
    internalTransfers: "الدفعات الداخلية",
    internalTransfersDesc: "مدفوعات لأقسام أو أفراد داخل الشركة",
    addTransfer: "إضافة دفعة داخلية",
    recipient: "المستفيد (الاسم)",
    department: "القسم / الإدارة",
    transferDate: "التاريخ",
    transferStatus: "الحالة",
    statusPaid: "مدفوعة",
    noTransfers: "لا توجد دفعات داخلية مسجلة بعد.",
    totalTransfers: "إجمالي الدفعات الداخلية",
    transfersPending: "دفعات معلقة",
    transfersPaid: "دفعات مسددة",
